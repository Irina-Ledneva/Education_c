...
{
    int firstRowIndex = 0; int lastRowIndex = arr2D.GetLength(0) - 1;
    for (int i = 0; i < arr2D.GetLength(1); i++)
    {
        int temp = arr2D[firstRowIndex, i]; arr2D[firstRowIndex, i] = arr2D[lastRowIndex, i]; arr2D[lastRowIndex, i] = temp;
    }
}
